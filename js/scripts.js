...
var dictionary = {
    ...
    'storycontent': {
        'en': 'On that fateful night, thanks to a terrible movie date (Dunkirk), we found each other instead ;o) The movie went about in detail about horrible ways in which soldiers could get killed. And it was looking very hopeless, and then, she turned on the charm machine aka lollipop. Best thing that ever happened to me that year ;o) That very moment, somehow we knew we were bound together. The next 3 years flew by! There was a lot of fun in the begining, and then we tested our relationship quite some. We even did the cursed Zushi beach trip, and yet we did not come undone ;o) There were a lot more tests that followed along with all the happiness, but in the end the happiness prevailed ;o) And once we covered On that fateful night, thanks to an unusual movie date (Dunkirk), we found each other instead. Aby was late and Alicja almost gave up his ticket. The movie went into detail about the horrible ways soldiers could get killed. It was looking very hopeless, and we kept asking each other whose idea was it. And that was when Alicja turned on the charm machine aka took out lollipops from her purse. It was best thing that happened to Aby that year (Note to Aby: not the first kiss? ;)). That very moment, somehow, we knew we were bound together. The following 5 years flew by! There was a lot of fun in the beginning. We tested our relationship quite some. We even made the commanded Alex Zushi beach trip, and yet we did not come undone. A lot more tests followed along with all the happiness, but in the end, the happiness prevailed. And once we covered the final frontier of Polish and Indian home trips, we knew we could survive despite our parents thinking we were a little crazy. We withstood 2+ years of the pandemic, 400km bike trip in August sun, a birthday proposal, drinking nights in Torami, and two white monstrous dogs in Niseko. And better yet, we started bringing out the best in each other. We pushed and pulled endlessly to get the paperwork to get married. We did not give up. Our love was stronger than before, but it looked less and less likely by the day, that we could get married because of the paperwork. But then, one day, to our dismay, the papers came. We acted quickly and on the 8th of August, we formally got married in the city hall. But we havent changed the vows and rings yet... Now we hope you can join us to celebrate the accomplishment of the impossible with us! And so here we are :)',
